        ...
        <div className='grid gap-y-4 lg:grid-cols-2 lg:gap-9'>
          <div className='relative' data-aos='zoom-in' data-aos-delay='1000' data-aos-offset='300'>
            ...
            <div className='absolute bottom-0 bg-white/20 backdrop-blur-md max-w-[300px] min-h-[150px] p-6'>
              ...
              <p>Lorem ipsum dolor sit amet consectetur adipiscing elit.Iste doloribus inventore hreum cumque blabities miniama.</p>
            </div>
          </div>
          <div className='relative' data-aos='zoom-in' data-aos-delay='1200' data-aos-offset='300'>
          ...
          <div className='relative' data-aos='zoom-in' data-aos-delay='1400' data-aos-offset='300'>
            <img src={Headset4} alt='' />
            <div className='absolute bottom-0 bg-white/20 backdrop-blur-md max-w-[300px] min-h-[150px] p-6'>
              <h4 className='font-semibold text-xl mb-2'>TPCASIT</h4>
              <p>Lorem ipsum dolor sit amet consectetur adipiscing elit.Iste doloribus inventore hreum cumque blabities miniama.</p>
            </div>
          </div>
        </div>
